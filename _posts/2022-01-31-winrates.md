...
data: for *i* ∈ {1, …, *n*}
<center> *x*<sub>*i*</sub> | *p* <sup>*ind*</sup>~ Bernoulli(*p*).</center>
...
[model](https://en.wikipedia.org/wiki/Bernoulli_distribution) for the
data: for *i* ∈ {1, …, *n*}
$$x_i\\mid p_i\\stackrel{ind}{\\sim}\\textsf{Bernoulli}(p_i).$$
Translating this model to English, this model says: the player has a
...
Then $Q=\\frac{1}{M}\\sum\_{i=1}^M\\delta\_{p_i}$, where *δ*<sub>⋅</sub>
is an [indicator
