...
literally data set. It's possible to use [conditional probability](https://en.wikipedia.org/wiki/Conditional_probability) to expand this into something resembling Model 2, but it doesn't actually end up getting us anywhere, so I'll spare the details.
...
![](2022-01-31-winrates_files/figure-markdown_github/unnamed-chunk-3-1.png?raw=true)
![](2022-01-31-winrates_files/figure-markdown_github/unnamed-chunk-4-1.png?raw=true)
